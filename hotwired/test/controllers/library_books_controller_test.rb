...
class LibraryBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library_book" do
    assert_difference("LibraryBook.count") do
      post library_books_url, params: { library_book: { description: @library_book.description, internal_info: @library_book.internal_info, status: @library_book.status, status_dat: @library_book.status_dat, title: @library_book.title } }
    end
  ...
  test "should update library_book" do
    patch library_book_url(@library_book), params: { library_book: { description: @library_book.description, internal_info: @library_book.internal_info, status: @library_book.status, status_dat: @library_book.status_dat, title: @library_book.title } }
